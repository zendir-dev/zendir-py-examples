...
universe: System = simulation.get_system(types.SOLAR_SYSTEM, Epoch=datetime(2024, 1, 1))
...
solar_panel: Object = spacecraft.add_child("SolarPanel", Efficiency=0.2, Area=0.06)
...
df = simulation.query_dataframe(solar_panel.get_message("Out_PowerMsg"))
